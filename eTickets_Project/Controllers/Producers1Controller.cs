...
{
    public class Producers1Controller : Controller
    {
        private readonly AppDbContext _context;

        public Producers1Controller(AppDbContext context)
        {
            _context = context;
        }
        ...
        // GET: Producers1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Producers1/Create
